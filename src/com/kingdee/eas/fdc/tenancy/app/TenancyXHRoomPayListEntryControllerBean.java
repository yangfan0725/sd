...
public class TenancyXHRoomPayListEntryControllerBean extends AbstractTenancyXHRoomPayListEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.tenancy.app.TenancyXHRoomPayListEntryControllerBean");
}