...
public class FundContract extends FDCBill implements IFundContract
{
    public FundContract()
    {
        super();
        registerInterface(IFundContract.class, this);
    }
    public FundContract(Context ctx)
    {
        super(ctx);
        registerInterface(IFundContract.class, this);
    }
    ...
    private FundContractController getController() throws BOSException
    {
        return (FundContractController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getFundContractInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFundContractInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFundContractInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFundContractCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFundContractCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFundContractCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
