 ...
 * output class name
 */
public abstract class AbstractPurchaseDocumentListUI extends com.kingdee.eas.fdc.basedata.client.FDCBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractPurchaseDocumentListUI.class);
     ...
     */
    public AbstractPurchaseDocumentListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractPurchaseDocumentListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.contract.app", "PurchaseDocumentQuery");
        //actionAudit
    ...
    public void initUIContentLayout()
    {
        ...
        kDSplitPane2.add(contInviteType, "bottom");
        //contProject
...
contInviteType.getContentPane().setLayout(new BorderLayout(0, 0));        contInviteType.getContentPane().add(kDScrollPane2, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.contract.app.PurchaseDocumentListUIHandler";
	}
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractPurchaseDocumentListUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractPurchaseDocumentListUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.contract.client", "PurchaseDocumentListUI");
    }
