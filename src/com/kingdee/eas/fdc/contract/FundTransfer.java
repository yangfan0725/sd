...
public class FundTransfer extends FDCBill implements IFundTransfer
{
    public FundTransfer()
    {
        super();
        registerInterface(IFundTransfer.class, this);
    }
    public FundTransfer(Context ctx)
    {
        super(ctx);
        registerInterface(IFundTransfer.class, this);
    }
    ...
    private FundTransferController getController() throws BOSException
    {
        return (FundTransferController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getFundTransferInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFundTransferInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFundTransferInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFundTransferCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFundTransferCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFundTransferCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
