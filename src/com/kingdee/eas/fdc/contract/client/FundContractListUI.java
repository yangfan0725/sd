 ...
 * output class name
 */
public class FundContractListUI extends AbstractFundContractListUI
{
    private static final Logger logger = CoreUIObject.getLogger(FundContractListUI.class);
    
    /**
     * output class constructor
     */
    public FundContractListUI() throws Exception
    {
        super();
    }
    ...
    public void onLoad() throws Exception {
    	...
    	this.tblMain.getColumn("rate").getStyleAttributes().setNumberFormat("#,##0.00;-#,##0.00");
    	this.tblMain.getColumn("rate").getStyleAttributes().setHorizontalAlign(HorizontalAlignment.RIGHT);
    	
    	this.tblMain.getColumn("exRate").getStyleAttributes().setNumberFormat("#,##0.00;-#,##0.00");
    	this.tblMain.getColumn("exRate").getStyleAttributes().setHorizontalAlign(HorizontalAlignment.RIGHT);
	...
	public void actionAudit_actionPerformed(ActionEvent e) throws Exception {
		...
		for(int i = 0; i < id.size(); i++){
			...
			if (!FDCBillStateEnum.SUBMITTED.equals(FundContractFactory.getRemoteInstance().getFundContractInfo(new ObjectUuidPK(id.get(i).toString())).getState())) {
	...
	public void actionUnAudit_actionPerformed(ActionEvent e) throws Exception {
		...
		for(int i = 0; i < id.size(); i++){
			FDCClientUtils.checkBillInWorkflow(this, id.get(i).toString());
			FundContractInfo info=FundContractFactory.getRemoteInstance().getFundContractInfo(new ObjectUuidPK(id.get(i).toString()));
...
//		mainQuery.setFilter(getTreeSelectFilter(project,type));
	...
	protected String getEditUIName() {
		return FundContractEditUI.class.getName();
	}
