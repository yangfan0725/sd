...
public class PurchaseDocumentEditDataProvider extends FDCBillDataProvider {

	public PurchaseDocumentEditDataProvider(String billId, IMetaDataPK mainQuery) {
		super(billId, mainQuery);
	}
	private static final Logger logger = Logger.getLogger(PurchaseDocumentEditDataProvider.class);
