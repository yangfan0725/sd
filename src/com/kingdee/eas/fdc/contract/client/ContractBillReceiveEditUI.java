...
import com.kingdee.eas.fdc.contract.client.ContractBillReceiveEditDataProvider;
...
import com.kingdee.eas.fdc.contract.client.ContractBillEditUI.IsLonelyChangeListener;
import com.kingdee.eas.fdc.contract.client.ContractBillEditUI.MyDataChangeListener;
 ...
 * output class name
 */
public class ContractBillReceiveEditUI extends AbstractContractBillReceiveEditUI
{
    public ContractBillReceiveEditUI() throws Exception {
		super();
		jbInit();
	}

	private static final Logger logger = CoreUIObject.getLogger(ContractBillReceiveEditUI.class);
...
//		}
	...
	public void actionPrint_actionPerformed(ActionEvent e) throws Exception {
		...
		ContractBillReceiveEditDataProvider dataPvd = new ContractBillReceiveEditDataProvider(
...
//		dataPvd.setBailId(editData.getBail().getId().toString());
	...
	protected String getTDFileName() {
		return "/bim/fdc/contract/ContractBillReceive";
	}

	protected IMetaDataPK getTDQueryPK() {
		return new MetaDataPK(
				"com.kingdee.eas.fdc.contract.app.ContractBillReceivePrintQuery");
	}
	...
	protected String getEditUIName() {
		return com.kingdee.eas.fdc.contract.client.ContractBillReceiveEditUI.class
				.getName();
	}
	...
	protected com.kingdee.eas.framework.ICoreBase getBizInterface()
			throws Exception {
		return com.kingdee.eas.fdc.contract.ContractBillReceiveFactory
				.getRemoteInstance();
	}
	...
	class MyDataChangeListener implements DataChangeListener {
		...
		public void dataChanged(DataChangeEvent eventObj) {
			...
			if (eventObj.getNewValue() != null) {
				info = (ContractBillReceiveInfo) eventObj.getNewValue();
				name = info.getName();
...
//					this.prmtpartB.setEnabled(true);
				...
				if(ContractPropertyEnum.SUPPLY.equals(contractProp)){
					...
					this.prmtpartB.setEnabled(true);
					this.prmtContractBill.setEnabled(true);
				}
			}
			String paramValue="true";
			try {
...
//			}
	...
	private KDBizPromptBox getContractF7Editor() {
		...
		kDBizPromptBoxContract.setQueryInfo("com.kingdee.eas.fdc.contract.app.ContractBillReceiveQuery");
...
//		 /*1305*/            prmtpartB.setCurrentCtrlUnit(ctrl);
//		                 }
//		 /*1307*/        prmtpartB.setSelector(selectorLisenterSupplier);
//		 /*1308*/        prmtpartB.setHasCUDefaultFilter(false);
//		 /*1309*/        prmtpartB.getQueryAgent().setDefaultFilterInfo(null);
		 ...
		 view.setFilter(filter);
		 prmtpartB.setEntityViewInfo(view);
		 prmtpartB.setQueryInfo("com.kingdee.eas.basedata.master.cssp.app.F7CustomerQueryWithDefaultStandard");
//		 FilterInfo Dfilter = null;
//
//		 /*1337*/        try
//		                 {
//		 /* <-MISALIGNED-> */ /*1337*/            if(!StringUtils.isEmpty(cuId))
//		 /* <-MISALIGNED-> */ /*1338*/                if(filterMap.containsKey(cuId))
//		                         {
//		 /* <-MISALIGNED-> */ /*1339*/                    Dfilter = (FilterInfo)filterMap.get(cuId);
//		                         } else
//		                         {
//		 /* <-MISALIGNED-> */ /*1341*/                    Dfilter = (FilterInfo)ActionCache.get("FDCBillEditUIHandler.dfilter");
//		 /* <-MISALIGNED-> */ /*1342*/                    if(Dfilter == null)
//		 /* <-MISALIGNED-> */ /*1343*/                        Dfilter = GlWebServiceUtil.getDFilterInfo(CustomerFactory.getRemoteInstance(), cuId);
//		 /* <-MISALIGNED-> */ /*1346*/                    filterMap.put(cuId, Dfilter);
//		                         }/*1349*/            if(Dfilter != null)
//		 /*1350*/                filterInfo.mergeFilter(Dfilter, "and");
//		                 } 
//		 					catch(Exception e)
//		                 {
...
//		 GeneralKDPromptSelectorAdaptor selectorLisenterSupplier1 = new GeneralKDPromptSelectorAdaptor(prmtpartC, "com.kingdee.eas.basedata.master.cssp.client.F7CustomerTreeDetailListUI", this, CSSPGroupInfo.getBosType(), "com.kingdee.eas.basedata.master.cssp.app.F7CustomerQuery", "browseGroup.id", "com.kingdee.eas.basedata.master.cssp.app.F7CustomerQuery", "com.kingdee.eas.basedata.master.cssp.app.F7CustomerQueryWithDefaultStandard");
//
//
//
//
//
//		 /*1300*/        if(cuId != null)
//		                 {/*1301*/            selectorLisenterSupplier1.setCUId(cuId);
//
//		 /*1303*/            CtrlUnitInfo ctrl = new CtrlUnitInfo();
//		 /*1304*/            ctrl.setId(BOSUuid.read(cuId));
//		 /*1305*/            prmtpartC.setCurrentCtrlUnit(ctrl);
//		                 }
//		 /*1307*/        prmtpartC.setSelector(selectorLisenterSupplier1);
//		 /*1308*/        prmtpartC.setHasCUDefaultFilter(false);
//		 /*1309*/        prmtpartC.getQueryAgent().setDefaultFilterInfo(null);
//
//		 /*1312*/        prmtpartC.setEntityViewInfo(view);
//		 prmtpartC.setQueryInfo("com.kingdee.eas.basedata.master.cssp.app.F7CustomerQueryWithDefaultStandard");
		 
		 view.setFilter(filter);
		 prmtpartC.setEntityViewInfo(view);
		 prmtpartC.setQueryInfo("com.kingdee.eas.basedata.master.cssp.app.F7CustomerQueryWithDefaultStandard");
...
//		this.cbOrgType.removeItem(ContractTypeOrgTypeEnum.SMALLRANGE);
		...
		view.setFilter(filter);
		this.prmtContractBill.setEntityViewInfo(view);
		
		this.actionUpLoad.setVisible(false);
		...
		this.kdtDetailEntry.getColumn("moneyDefine").setEditor(moneyDefineEditor);
		this.kdtDetailEntry.getColumn("totalAmount").getStyleAttributes().setHided(true);
		this.kdtDetailEntry.getColumn("rate").getStyleAttributes().setHided(true);
		this.kdtDetailEntry.getColumn("amount").getStyleAttributes().setHided(true);
		this.kdtDetailEntry.getColumn("moneyDefine").setWidth(300);
		this.kdtDetailEntry.getColumn("remark").setWidth(300);
	...
	@Override
	protected void costProperty_itemStateChanged(ItemEvent e) throws Exception {
		// TODO Auto-generated method stub
		super.costProperty_itemStateChanged(e);
		if(CostPropertyEnum.COMP_COMFIRM.equals(costProperty.getSelectedItem())){
			this.txtamount.setEnabled(true);
		}else{
			this.txtamount.setEnabled(false);
...
//		sic.add(new SelectorItemInfo("programmingContract.programming.*"));
	...
	private void storeDetailEntries() {
		ContractBillReceiveEntryInfo entryInfo = null;
		int count = getDetailInfoTable().getRowCount();
		ContractBillReceiveInfo billInfo = new ContractBillReceiveInfo();
		...
		for (int i = 0; i < count; i++) {
			entryInfo = new ContractBillReceiveEntryInfo();
...
//				editData.setOriginalAmount(FDCHelper.divide(FDCHelper.toBigDecimal(content), txtExRate.getBigDecimalValue()));
	...
	protected void loadDetailEntries() {
		...
		ContractBillReceiveEntryCollection coll = editData.getEntrys();
		...
		for (int i = 0; i < size; i++) {
			entryInfo = (ContractBillReceiveEntryInfo) coll.get(i);
	...
	protected void tblDetail_editStopping(
		...
		if (colKey.equals("content")&&NU_ROW.equals(entryRow.getCell(ROWKEY_COL).getValue())&&ContractPropertyEnum.SUPPLY.equals(this.contractPropert.getSelectedItem())){
			if(newValue==null){
				...
				ContractBillReceiveInfo contractBillInfo=(ContractBillReceiveInfo)newValue;
				...
				if(contractBillInfo.getPartB()!=null){
					this.prmtpartB.setValue(CustomerFactory.getRemoteInstance().getCustomerInfo(new ObjectUuidPK(contractBillInfo.getPartB().getId())));
				}
				if(contractBillInfo.getContractBill()!=null){
					this.prmtContractBill.setValue(ContractBillFactory.getRemoteInstance().getContractBillInfo(new ObjectUuidPK(contractBillInfo.getContractBill().getId())));
				}
				contractBillInfo =ContractBillReceiveFactory.getRemoteInstance().getContractBillReceiveInfo(new ObjectUuidPK(contractBillInfo.getId()));
...
//		}
	...
	private void verifyInputForContractDetail(){
		...
		for (int i = 0, size = coll.size(); i < size ; i++){
			ContractBillReceiveEntryInfo entryInfo = coll.get(i);
	...
	protected void verifyInputForSubmint() throws Exception {
		...
		//预算控制
		checkMbgCtrlBalance();
		FDCClientVerifyHelper.verifyEmpty(this, txtHttk);
//		FDCClientVerifyHelper.verifyEmpty(this, prmtContractBill);
		FDCClientVerifyHelper.verifyEmpty(this, prmtcontractType);
		FDCClientVerifyHelper.verifyEmpty(this, costProperty);
		//增加校验
		FDCClientVerifyHelper.verifyEmpty(this, prmtpartB);
		FDCClientVerifyHelper.verifyEmpty(this, prmtlandDeveloper);
...
//		FDCClientVerifyHelper.verifyEmpty(this, this.txtCompanyNameA);
//		FDCClientVerifyHelper.verifyEmpty(this, this.txtAccountA);
//		FDCClientVerifyHelper.verifyEmpty(this, this.txtBankA);
//		FDCClientVerifyHelper.verifyEmpty(this, this.txtKpAccountA);
//		FDCClientVerifyHelper.verifyEmpty(this, this.txtKpBankA);
//		FDCClientVerifyHelper.verifyEmpty(this, this.txtKpCompanyNameA);
//		FDCClientVerifyHelper.verifyEmpty(this, this.txtAddressA);
//		FDCClientVerifyHelper.verifyEmpty(this, this.txtTelA);
//		FDCClientVerifyHelper.verifyEmpty(this, this.txtTaxNumA);
//		
//		FDCClientVerifyHelper.verifyEmpty(this, this.txtCompanyNameB);
//		FDCClientVerifyHelper.verifyEmpty(this, this.txtAccountB);
//		FDCClientVerifyHelper.verifyEmpty(this, this.txtBankB);
//		FDCClientVerifyHelper.verifyEmpty(this, this.txtKpAccountB);
//		FDCClientVerifyHelper.verifyEmpty(this, this.txtKpBankB);
//		FDCClientVerifyHelper.verifyEmpty(this, this.txtKpCompanyNameB);
//		FDCClientVerifyHelper.verifyEmpty(this, this.txtAddressB);
//		FDCClientVerifyHelper.verifyEmpty(this, this.txtTelB);
//		FDCClientVerifyHelper.verifyEmpty(this, this.txtTaxNumB);
		if(this.kdtDetailEntry.getRowCount()==0){
			FDCMsgBox.showWarning(this,"合同签订明细不能为空！");
			SysUtil.abort();
		}
		for(int i=0;i<this.kdtDetailEntry.getRowCount();i++){
			if(this.kdtDetailEntry.getRow(i).getCell("moneyDefine").getValue()==null){
				FDCMsgBox.showWarning(this,"费用类型不能为空！");
				SysUtil.abort();
			}
		}
		if(!ContractPropertyEnum.SUPPLY.equals(contractPropert.getSelectedItem())){
...
//		this.prmtcontractType.getValue();
		if(!this.chkIsOpen.isSelected()&&islitterAmount()&&ContractPropertyEnum.DIRECT.equals(this.editData.getContractPropert())
//				&&this.editData.getProgrammingContract() != null
				){//直接合同
			UIContext uiContext = new UIContext(this);
			...
			ContractBillReceiveEntryCollection  entryColl = editData.getEntrys();
			for(int i = 0 ; i < entryColl.size();i++){
				ContractBillReceiveEntryInfo entryInfo = entryColl.get(i);
...
//			planAmount = FDCHelper.subtract(planAmount, this.editData.getProgrammingContract().getSignUpAmount());
	...
	private void checkMbgCtrlBalance() throws BOSException, EASBizException {
		//根据参数是否显示合同费用项目
		if (!isShowCharge 
//				|| editData.getConChargeType() == null
				) {
			return;
		}
	...
	public void actionViewBgBalance_actionPerformed(ActionEvent e) throws Exception {
		...
		editData.setBizDate((Date) this.pkbookedDate.getValue());
		ContractBillReceiveInfo info = editData;
		IBgControlFacade iCtrl = BgControlFacadeFactory.getRemoteInstance();
...
//		}
	...
	private void showProgramContract() throws Exception {
		IUIWindow uiWindow = null;
		UIContext uiContext = new UIContext(this);
		ContractBillReceiveInfo contractBillInfo = editData;
...
//					contentInfo.setContract(editData);
	...
	public boolean destroyWindow() {
        ...
        if(b){
        	try {
    			IContractBillReceive contractBillFacade = null;
    			contractBillFacade = ContractBillReceiveFactory.getRemoteInstance();
	...
	protected void initTable() {
		...
		this.kdtDetailEntry.getColumn("moneyDefine").setRequired(true);
...
//					row.getCell("amount").setValue(FDCHelper.divide(FDCHelper.multiply(this.txtLocalAmount.getBigDecimalValue(),row.getCell("rate").getValue()), new BigDecimal(100), 2, BigDecimal.ROUND_HALF_UP));
	...
	public void actionDetailALine_actionPerformed(ActionEvent e) throws Exception {
		...
		ContractBillReceiveRateEntryInfo info = new ContractBillReceiveRateEntryInfo();
		info.setId(BOSUuid.create(info.getBOSType()));
...
//		}
	...
	public void actionWorkFlowG_actionPerformed(ActionEvent e) throws Exception {
    	...
    	ContractBillReceiveCollection col=ContractBillReceiveFactory.getRemoteInstance().getContractBillReceiveCollection("select * from where id='"+id+"'");
