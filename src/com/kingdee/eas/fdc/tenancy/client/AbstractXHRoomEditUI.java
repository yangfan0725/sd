 ...
 * output class name
 */
public abstract class AbstractXHRoomEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBaseDataEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractXHRoomEditUI.class);
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contNumber;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contName;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contArea;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contIsSale;
    protected com.kingdee.bos.ctrl.swing.KDTextField txtNumber;
    protected com.kingdee.bos.ctrl.extendcontrols.KDBizMultiLangBox txtName;
    protected com.kingdee.bos.ctrl.swing.KDFormattedTextField txtArea;
    protected com.kingdee.bos.ctrl.swing.KDComboBox cbIsSale;
    protected com.kingdee.eas.fdc.tenancy.XHRoomInfo editData = null;
     ...
     */
    public AbstractXHRoomEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractXHRoomEditUI.class.getName());
        ...
        this.contIsSale = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.txtNumber = new com.kingdee.bos.ctrl.swing.KDTextField();
        this.txtName = new com.kingdee.bos.ctrl.extendcontrols.KDBizMultiLangBox();
        this.txtArea = new com.kingdee.bos.ctrl.swing.KDFormattedTextField();
        this.cbIsSale = new com.kingdee.bos.ctrl.swing.KDComboBox();
        this.contNumber.setName("contNumber");
        this.contName.setName("contName");
        this.contArea.setName("contArea");
        this.contIsSale.setName("contIsSale");
        this.txtNumber.setName("txtNumber");
        this.txtName.setName("txtName");
        this.txtArea.setName("txtArea");
        this.cbIsSale.setName("cbIsSale");
        // CoreUI
        // contNumber		
        ...
        // contIsSale		
        this.contIsSale.setBoundLabelText(resHelper.getString("contIsSale.boundLabelText"));		
        this.contIsSale.setBoundLabelLength(100);		
        this.contIsSale.setBoundLabelUnderline(true);
        // txtNumber
        // txtName
        // txtArea		
        ...
        // cbIsSale		
        this.cbIsSale.addItems(EnumUtils.getEnumList("com.kingdee.eas.fdc.contract.app.YesOrNoEnum").toArray());
    ...
    public void initUIContentLayout()
    {
        ...
        contName.setBounds(new Rectangle(11, 37, 270, 19));
        this.add(contName, null);
        contArea.setBounds(new Rectangle(11, 66, 270, 19));
        this.add(contArea, null);
        contIsSale.setBounds(new Rectangle(11, 95, 270, 19));
        this.add(contIsSale, null);
        //contNumber
        ...
        //contIsSale
        contIsSale.setBoundEditor(cbIsSale);
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("isSale", com.kingdee.eas.fdc.contract.app.YesOrNoEnum.class, this.cbIsSale, "selectedItem");		
	}
	//Regiester UI State
	private void registerUIState(){		
	}
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.tenancy.app.XHRoomEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.tenancy.XHRoomInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("isSale", ValidateHelper.ON_SAVE);    		
	}
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("isSale"));
        return sic;
    }        
    ...
    protected class ActionALine extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractXHRoomEditUI.this, "ActionALine", "actionALine_actionPerformed", e);
        }
    }
    ...
    protected class ActionILine extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractXHRoomEditUI.this, "ActionILine", "actionILine_actionPerformed", e);
        }
    }
    ...
    protected class ActionRLine extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractXHRoomEditUI.this, "ActionRLine", "actionRLine_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.tenancy.client", "XHRoomEditUI");
    }
