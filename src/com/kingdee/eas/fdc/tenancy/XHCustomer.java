...
public class XHCustomer extends FDCDataBase implements IXHCustomer
{
    public XHCustomer()
    {
        super();
        registerInterface(IXHCustomer.class, this);
    }
    public XHCustomer(Context ctx)
    {
        super(ctx);
        registerInterface(IXHCustomer.class, this);
    }
    ...
    private XHCustomerController getController() throws BOSException
    {
        return (XHCustomerController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getXHCustomerInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getXHCustomerInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getXHCustomerInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getXHCustomerCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getXHCustomerCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getXHCustomerCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
