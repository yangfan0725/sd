...
public class OtherBillListUI extends AbstractOtherBillListUI
{
    ...
    public void onLoad() throws Exception {
		...
		CRMClientHelper.changeTableNumberFormat(tblMain, new String[]{"entry.amount","entry.workload","entry.price","entry.totalAmount"});
    ...
    protected void afterTableFillData(KDTDataRequestEvent e) {
		...
		CRMClientHelper.getFootRow(tblMain, new String[]{"entry.amount","entry.workload","entry.price","entry.totalAmount"});
	}
