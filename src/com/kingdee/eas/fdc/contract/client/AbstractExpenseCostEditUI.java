 ...
 * output class name
 */
public abstract class AbstractExpenseCostEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractExpenseCostEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDWorkButton btnViewApply;
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contAccountNumber;
    ...
    protected com.kingdee.bos.ctrl.swing.KDComboBox cbExpenseType;
    ...
    protected com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox prmtBankNum;
    protected com.kingdee.bos.ctrl.swing.KDTextField txtAccountNumber;
    protected com.kingdee.bos.ctrl.swing.KDTextField txtName;
    protected com.kingdee.eas.fdc.contract.ExpenseCostInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractExpenseCostEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractExpenseCostEditUI.class.getName());
        ...
        this.btnViewApply = new com.kingdee.bos.ctrl.swing.KDWorkButton();
        ...
        this.contAccountNumber = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.cbExpenseType = new com.kingdee.bos.ctrl.swing.KDComboBox();
        ...
        this.prmtBankNum = new com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox();
        this.txtAccountNumber = new com.kingdee.bos.ctrl.swing.KDTextField();
        ...
        this.btnViewApply.setName("btnViewApply");
        this.contContractWFType.setName("contContractWFType");
        this.contBankNum.setName("contBankNum");
        this.contAccountNumber.setName("contAccountNumber");
        ...
        this.cbExpenseType.setName("cbExpenseType");
        ...
        this.prmtBankNum.setName("prmtBankNum");
        this.txtAccountNumber.setName("txtAccountNumber");
        ...
        // tblEntry
		String tblEntryStrXML = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><DocRoot xmlns:c=\"http://www.kingdee.com/Common\" xmlns:f=\"http://www.kingdee.com/Form\" xmlns:t=\"http://www.kingdee.com/Table\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"http://www.kingdee.com/KDF KDFSchema.xsd\" version=\"0.0\"><Styles><c:Style id=\"sCol0\"><c:Protection hidden=\"true\" /></c:Style><c:Style id=\"sCol1\"><c:Protection locked=\"true\" /></c:Style><c:Style id=\"sCol3\"><c:Protection hidden=\"true\" /></c:Style><c:Style id=\"sCol4\"><c:Protection hidden=\"true\" /></c:Style><c:Style id=\"sCol5\"><c:Protection hidden=\"true\" /></c:Style><c:Style id=\"sCol6\"><c:Protection hidden=\"true\" /></c:Style></Styles><Table id=\"KDTable\"><t:Sheet name=\"sheet1\"><t:Table t:selectMode=\"15\" t:mergeMode=\"0\" t:dataRequestMode=\"0\" t:pageRowCount=\"100\"><t:ColumnGroup><t:Column t:key=\"id\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol0\" /><t:Column t:key=\"detail\" t:width=\"380\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol1\" /><t:Column t:key=\"content\" t:width=\"500\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /><t:Column t:key=\"desc\" t:width=\"500\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol3\" /><t:Column t:key=\"rowKey\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol4\" /><t:Column t:key=\"dataType\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol5\" /><t:Column t:key=\"detailDef.id\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol6\" /></t:ColumnGroup><t:Head><t:Row t:name=\"header\" t:height=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\"><t:Cell>$Resource{id}</t:Cell><t:Cell>$Resource{detail}</t:Cell><t:Cell>$Resource{content}</t:Cell><t:Cell>$Resource{desc}</t:Cell><t:Cell>$Resource{rowKey}</t:Cell><t:Cell>$Resource{dataType}</t:Cell><t:Cell>$Resource{detailDef.id}</t:Cell></t:Row></t:Head></t:Table><t:SheetOptions><t:MergeBlocks><t:Head /></t:MergeBlocks></t:SheetOptions></t:Sheet></Table></DocRoot>";
        ...
        this.tblEntry.addKDTEditListener(new com.kingdee.bos.ctrl.kdf.table.event.KDTEditAdapter() {
            public void editStopping(com.kingdee.bos.ctrl.kdf.table.event.KDTEditEvent e) {
                ...
                this.tblEntry.putBindContents("editData",new String[] {"id","detail","content","desc","rowKey","dataType","detailDefID"});
        ...
        // btnViewApply		
        this.btnViewApply.setText(resHelper.getString("btnViewApply.text"));
        this.btnViewApply.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent e) {
                beforeActionPerformed(e);
                try {
                    btnViewApply_actionPerformed(e);
                } catch (Exception exc) {
                    handUIException(exc);
                } finally {
        ...
        // contAccountNumber		
        this.contAccountNumber.setBoundLabelText(resHelper.getString("contAccountNumber.boundLabelText"));		
        this.contAccountNumber.setBoundLabelUnderline(true);		
        this.contAccountNumber.setBoundLabelLength(100);
        // contName		
        ...
        // cbExpenseType		
        this.cbExpenseType.setRequired(true);		
        this.cbExpenseType.addItems(EnumUtils.getEnumList("com.kingdee.eas.fdc.contract.ExpenseTypeEnum").toArray());		
        this.cbExpenseType.setEnabled(false);
        this.cbExpenseType.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent e) {
                try {
                    cbExpenseType_itemStateChanged(e);
                } catch (Exception exc) {
                    handUIException(exc);
                } finally {
                }
        ...
        // prmtBankNum		
        this.prmtBankNum.setQueryInfo("com.kingdee.eas.fdc.contract.app.BankNumQuery");		
        this.prmtBankNum.setCommitFormat("$name$");		
        this.prmtBankNum.setDisplayFormat("$name$");		
        this.prmtBankNum.setEditFormat("$name$");		
        this.prmtBankNum.setRequired(true);		
        this.prmtBankNum.setEditable(true);
        // txtAccountNumber		
        this.txtAccountNumber.setRequired(true);
        // txtName		
    ...
    public void initUIContentLayout()
    {
        ...
        contAttachment.setBounds(new Rectangle(22, 385, 976, 123));
        this.add(contAttachment, new KDLayout.Constraints(22, 385, 976, 123, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        contContractType.setBounds(new Rectangle(22, 32, 270, 19));
        this.add(contContractType, new KDLayout.Constraints(22, 32, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contBizDate.setBounds(new Rectangle(22, 55, 270, 19));
        this.add(contBizDate, new KDLayout.Constraints(22, 55, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contAmount.setBounds(new Rectangle(726, 78, 270, 19));
        this.add(contAmount, new KDLayout.Constraints(726, 78, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contExpenseType.setBounds(new Rectangle(374, 32, 270, 19));
        this.add(contExpenseType, new KDLayout.Constraints(374, 32, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contApplyAmount.setBounds(new Rectangle(374, 78, 270, 19));
        this.add(contApplyAmount, new KDLayout.Constraints(374, 78, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contDept.setBounds(new Rectangle(374, 55, 270, 19));
        this.add(contDept, new KDLayout.Constraints(374, 55, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contPerson.setBounds(new Rectangle(726, 55, 270, 19));
        this.add(contPerson, new KDLayout.Constraints(726, 55, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contPurpose.setBounds(new Rectangle(24, 300, 970, 84));
        this.add(contPurpose, new KDLayout.Constraints(24, 300, 970, 84, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        tblEntry.setBounds(new Rectangle(22, 131, 808, 165));
        this.add(tblEntry, new KDLayout.Constraints(22, 131, 808, 165, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contSupplier.setBounds(new Rectangle(22, 101, 270, 19));
        this.add(contSupplier, new KDLayout.Constraints(22, 101, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        btnViewApply.setBounds(new Rectangle(865, 131, 130, 19));
        this.add(btnViewApply, new KDLayout.Constraints(865, 131, 130, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contContractWFType.setBounds(new Rectangle(726, 32, 270, 19));
        this.add(contContractWFType, new KDLayout.Constraints(726, 32, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contBankNum.setBounds(new Rectangle(374, 101, 270, 19));
        this.add(contBankNum, new KDLayout.Constraints(374, 101, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contAccountNumber.setBounds(new Rectangle(726, 101, 270, 19));
        this.add(contAccountNumber, new KDLayout.Constraints(726, 101, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contName.setBounds(new Rectangle(22, 78, 270, 19));
        this.add(contName, new KDLayout.Constraints(22, 78, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        //contCreator
...
contAttachment.getContentPane().setLayout(new BorderLayout(0, 0));        contAttachment.getContentPane().add(tblAttachement, BorderLayout.CENTER);
        ...
        //contExpenseType
        contExpenseType.setBoundEditor(cbExpenseType);
        //contApplyAmount
        ...
        //contBankNum
        contBankNum.setBoundEditor(prmtBankNum);
        //contAccountNumber
        contAccountNumber.setBoundEditor(txtAccountNumber);
        //contName
	...
	private void registerBindings(){
		dataBinder.registerBinding("entry", com.kingdee.eas.fdc.contract.ExpenseCostEntryInfo.class, this.tblEntry, "userObject");
		dataBinder.registerBinding("entry.id", com.kingdee.bos.util.BOSUuid.class, this.tblEntry, "id.text");
		dataBinder.registerBinding("entry.detail", String.class, this.tblEntry, "detail.text");
		dataBinder.registerBinding("entry.content", String.class, this.tblEntry, "content.text");
		dataBinder.registerBinding("entry.desc", String.class, this.tblEntry, "desc.text");
		dataBinder.registerBinding("entry.rowKey", String.class, this.tblEntry, "rowKey.text");
		dataBinder.registerBinding("entry.dataType", com.kingdee.eas.fdc.basedata.DataTypeEnum.class, this.tblEntry, "dataType.text");
		dataBinder.registerBinding("entry.detailDefID", String.class, this.tblEntry, "detailDef.id.text");
		...
		dataBinder.registerBinding("expenseType", com.kingdee.eas.fdc.contract.ExpenseTypeEnum.class, this.cbExpenseType, "selectedItem");
		dataBinder.registerBinding("expenseApply.amount", java.math.BigDecimal.class, this.txtApplyAmount, "value");
		...
		dataBinder.registerBinding("receiveBank", String.class, this.prmtBankNum, "data");
		dataBinder.registerBinding("accountNumber", String.class, this.txtAccountNumber, "text");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.contract.app.ExpenseCostEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.contract.ExpenseCostInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("entry.detail", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entry.content", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entry.desc", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entry.rowKey", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entry.dataType", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entry.detailDefID", ValidateHelper.ON_SAVE);    
		...
		getValidateHelper().registerBindProperty("expenseApply.amount", ValidateHelper.ON_SAVE);    
		...
		getValidateHelper().registerBindProperty("receiveBank", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("accountNumber", ValidateHelper.ON_SAVE);    
    ...
    /**
     * output btnViewApply_actionPerformed method
     */
    protected void btnViewApply_actionPerformed(java.awt.event.ActionEvent e) throws Exception
    {
    }
    ...
    /**
     * output cbExpenseType_itemStateChanged method
     */
    protected void cbExpenseType_itemStateChanged(java.awt.event.ItemEvent e) throws Exception
    {
    }
    ...
    public SelectorItemCollection getSelectors()
    {
    	...
    	sic.add(new SelectorItemInfo("entry.rowKey"));
    	sic.add(new SelectorItemInfo("entry.dataType"));
    	sic.add(new SelectorItemInfo("entry.detailDefID"));
		if(selectorAll.equalsIgnoreCase("true"))
		{
        ...
        sic.add(new SelectorItemInfo("expenseApply.amount"));
		if(selectorAll.equalsIgnoreCase("true"))
		{
        ...
        sic.add(new SelectorItemInfo("receiveBank"));
        sic.add(new SelectorItemInfo("accountNumber"));
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.contract.client", "ExpenseCostEditUI");
    }
    /**
