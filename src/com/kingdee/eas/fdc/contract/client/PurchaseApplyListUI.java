 ...
 * output class name
 */
public class PurchaseApplyListUI extends AbstractPurchaseApplyListUI
{
    private static final Logger logger = CoreUIObject.getLogger(PurchaseApplyListUI.class);
    ...
    public PurchaseApplyListUI() throws Exception
    {
        super();
    }
	...
	public void actionAudit_actionPerformed(ActionEvent e) throws Exception {
		...
		for(int i = 0; i < id.size(); i++){
			...
			if (!FDCBillStateEnum.SUBMITTED.equals(PurchaseApplyFactory.getRemoteInstance().getPurchaseApplyInfo(new ObjectUuidPK(id.get(i).toString())).getState())) {
	...
	public void actionUnAudit_actionPerformed(ActionEvent e) throws Exception {
		...
		for(int i = 0; i < id.size(); i++){
			FDCClientUtils.checkBillInWorkflow(this, id.get(i).toString());
			PurchaseApplyInfo info=PurchaseApplyFactory.getRemoteInstance().getPurchaseApplyInfo(new ObjectUuidPK(id.get(i).toString()));
...
//		mainQuery.setFilter(getTreeSelectFilter(project,type));
	...
	protected String getEditUIName() {
		return PurchaseApplyEditUI.class.getName();
	}
