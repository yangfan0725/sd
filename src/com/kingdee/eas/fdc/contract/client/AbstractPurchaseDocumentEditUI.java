 ...
 * output class name
 */
public abstract class AbstractPurchaseDocumentEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractPurchaseDocumentEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contPurchaseMode;
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contBelong;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contAmount;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contAmountBig;
    ...
    protected com.kingdee.bos.ctrl.swing.KDComboBox cbBelong;
    protected com.kingdee.bos.ctrl.swing.KDFormattedTextField txtAmount;
    protected com.kingdee.bos.ctrl.swing.KDTextField txtAmountBig;
    protected com.kingdee.bos.ctrl.swing.KDComboBox cbPurchaseType;
    protected com.kingdee.eas.fdc.contract.PurchaseDocumentInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractPurchaseDocumentEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractPurchaseDocumentEditUI.class.getName());
        ...
        this.contPurchaseMode = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.contBelong = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.contAmount = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.contAmountBig = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.cbBelong = new com.kingdee.bos.ctrl.swing.KDComboBox();
        this.txtAmount = new com.kingdee.bos.ctrl.swing.KDFormattedTextField();
        this.txtAmountBig = new com.kingdee.bos.ctrl.swing.KDTextField();
        this.cbPurchaseType = new com.kingdee.bos.ctrl.swing.KDComboBox();
        ...
        this.contPurchaseMode.setName("contPurchaseMode");
        ...
        this.contBelong.setName("contBelong");
        this.contAmount.setName("contAmount");
        this.contAmountBig.setName("contAmountBig");
        ...
        this.cbBelong.setName("cbBelong");
        this.txtAmount.setName("txtAmount");
        this.txtAmountBig.setName("txtAmountBig");
        this.cbPurchaseType.setName("cbPurchaseType");
        // CoreUI		
        ...
        // contPurchaseMode		
        this.contPurchaseMode.setBoundLabelText(resHelper.getString("contPurchaseMode.boundLabelText"));		
        this.contPurchaseMode.setBoundLabelLength(100);		
        this.contPurchaseMode.setBoundLabelUnderline(true);
        // contNeedDept		
        ...
        // contBelong		
        this.contBelong.setBoundLabelText(resHelper.getString("contBelong.boundLabelText"));		
        this.contBelong.setBoundLabelLength(100);		
        this.contBelong.setBoundLabelUnderline(true);
        // contAmount		
        this.contAmount.setBoundLabelText(resHelper.getString("contAmount.boundLabelText"));		
        this.contAmount.setBoundLabelLength(100);		
        this.contAmount.setBoundLabelUnderline(true);
        // contAmountBig		
        this.contAmountBig.setBoundLabelText(resHelper.getString("contAmountBig.boundLabelText"));		
        this.contAmountBig.setBoundLabelLength(100);		
        this.contAmountBig.setBoundLabelUnderline(true);
        // contPurchaseType		
        ...
        // prmtInviteType		
        this.prmtInviteType.setQueryInfo("com.kingdee.eas.fdc.basedata.app.F7ContractTypeQuery");		
        ...
        // prmtPurchaseMode		
        this.prmtPurchaseMode.setQueryInfo("com.kingdee.eas.fdc.contract.app.ContractWFQuery");		
        this.prmtPurchaseMode.setCommitFormat("$longNumber$");		
        this.prmtPurchaseMode.setEditFormat("$longNumber$");		
        this.prmtPurchaseMode.setDisplayFormat("$name$");		
        ...
        // cbBelong		
        this.cbBelong.addItems(EnumUtils.getEnumList("com.kingdee.eas.fdc.contract.PurchaseBelongEnum").toArray());		
        this.cbBelong.setRequired(true);
        // txtAmount		
        ...
        // txtAmountBig		
        this.txtAmountBig.setEnabled(false);
        // cbPurchaseType		
        this.cbPurchaseType.addItems(EnumUtils.getEnumList("com.kingdee.eas.fdc.contract.PurchaseTypeEnum").toArray());
    ...
    public void initUIContentLayout()
    {
        ...
        contCreator.setBounds(new Rectangle(374, 494, 270, 19));
        this.add(contCreator, new KDLayout.Constraints(374, 494, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contCreateTime.setBounds(new Rectangle(22, 494, 270, 19));
        this.add(contCreateTime, new KDLayout.Constraints(22, 494, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contName.setBounds(new Rectangle(374, 48, 270, 19));
        this.add(contName, new KDLayout.Constraints(374, 48, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contInviteType.setBounds(new Rectangle(22, 86, 270, 19));
        this.add(contInviteType, new KDLayout.Constraints(22, 86, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contPurchaseMode.setBounds(new Rectangle(374, 86, 270, 19));
        this.add(contPurchaseMode, new KDLayout.Constraints(374, 86, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contNeedDept.setBounds(new Rectangle(22, 162, 270, 19));
        this.add(contNeedDept, new KDLayout.Constraints(22, 162, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contRespPerson.setBounds(new Rectangle(374, 162, 270, 19));
        this.add(contRespPerson, new KDLayout.Constraints(374, 162, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contPurpose.setBounds(new Rectangle(22, 201, 974, 106));
        this.add(contPurpose, new KDLayout.Constraints(22, 201, 974, 106, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        contAttachment.setBounds(new Rectangle(22, 319, 972, 156));
        this.add(contAttachment, new KDLayout.Constraints(22, 319, 972, 156, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        contBizDate.setBounds(new Rectangle(22, 48, 270, 19));
        this.add(contBizDate, new KDLayout.Constraints(22, 48, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contBelong.setBounds(new Rectangle(726, 86, 270, 19));
        this.add(contBelong, new KDLayout.Constraints(726, 86, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contAmount.setBounds(new Rectangle(22, 124, 270, 19));
        this.add(contAmount, new KDLayout.Constraints(22, 124, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contAmountBig.setBounds(new Rectangle(374, 124, 270, 19));
        this.add(contAmountBig, new KDLayout.Constraints(374, 124, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contPurchaseType.setBounds(new Rectangle(726, 124, 270, 19));
        this.add(contPurchaseType, new KDLayout.Constraints(726, 124, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        //contCreator
        ...
        //contPurchaseMode
        contPurchaseMode.setBoundEditor(prmtPurchaseMode);
        //contNeedDept
...
contAttachment.getContentPane().setLayout(new BorderLayout(0, 0));        contAttachment.getContentPane().add(tblAttachement, BorderLayout.CENTER);
        ...
        //contBelong
        contBelong.setBoundEditor(cbBelong);
        //contAmount
        contAmount.setBoundEditor(txtAmount);
        //contAmountBig
        contAmountBig.setBoundEditor(txtAmountBig);
        //contPurchaseType
        contPurchaseType.setBoundEditor(cbPurchaseType);
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("purchaseMode", com.kingdee.eas.fdc.invite.InvitePurchaseModeInfo.class, this.prmtPurchaseMode, "data");
		...
		dataBinder.registerBinding("belong", com.kingdee.eas.fdc.contract.PurchaseBelongEnum.class, this.cbBelong, "selectedItem");
		dataBinder.registerBinding("amount", java.math.BigDecimal.class, this.txtAmount, "value");
		dataBinder.registerBinding("purchaseType", com.kingdee.eas.fdc.contract.PurchaseTypeEnum.class, this.cbPurchaseType, "selectedItem");		
	}
	//Regiester UI State
	private void registerUIState(){		
	}
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.contract.app.PurchaseDocumentEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.contract.PurchaseDocumentInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("purchaseMode", ValidateHelper.ON_SAVE);    
    ...
    public SelectorItemCollection getSelectors()
    {
		...
		if(selectorAll.equalsIgnoreCase("true"))
		{
			sic.add(new SelectorItemInfo("purchaseMode.*"));
		}
		else{
        	sic.add(new SelectorItemInfo("purchaseMode.id"));
        	sic.add(new SelectorItemInfo("purchaseMode.number"));
        	sic.add(new SelectorItemInfo("purchaseMode.name"));
        	sic.add(new SelectorItemInfo("purchaseMode.longNumber"));
		}
		if(selectorAll.equalsIgnoreCase("true"))
		{
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.contract.client", "PurchaseDocumentEditUI");
    }
    /**
