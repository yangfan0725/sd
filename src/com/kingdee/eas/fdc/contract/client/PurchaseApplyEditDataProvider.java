...
public class PurchaseApplyEditDataProvider extends FDCBillDataProvider {

	public PurchaseApplyEditDataProvider(String billId, IMetaDataPK mainQuery) {
		super(billId, mainQuery);
	}
	private static final Logger logger = Logger.getLogger(PurchaseApplyEditDataProvider.class);
