...
public class ExpenseApplyEditDataProvider extends FDCBillDataProvider  {

	public ExpenseApplyEditDataProvider(String billId, IMetaDataPK mainQuery) {
		super(billId, mainQuery);
		// TODO Auto-generated constructor stub
	}
private static final Logger logger = Logger.getLogger(ExpenseApplyEditDataProvider.class);
	...
	public IRowSet getOtherSubRowSet(BOSQueryDataSource ds) {
		if (ds.getID().equalsIgnoreCase("AttachmentQuery")) {
			...
			return iRowSet;
		}else if(ds.getID().endsWith("ExpenseApplyEntryQuery")){
			IRowSet iRowSet = null;
			try {
				IQueryExecutor exec = QueryExecutorFactory.getRemoteInstance(new MetaDataPK(
						"com.kingdee.eas.fdc.contract.app.ExpenseApplyEntryQuery"));
				exec.option().isAutoTranslateEnum = true;
				EntityViewInfo ev = new EntityViewInfo();
				FilterInfo filter = new FilterInfo();
