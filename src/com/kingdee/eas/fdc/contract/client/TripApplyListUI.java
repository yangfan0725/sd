...
import com.kingdee.eas.fdc.aimcost.client.MeasureCostListUI;
 ...
 * output class name
 */
public class TripApplyListUI extends AbstractTripApplyListUI
{
    private static final Logger logger = CoreUIObject.getLogger(TripApplyListUI.class);
    
    /**
     * output class constructor
     */
    public TripApplyListUI() throws Exception
    {
        super();
    }
	...
	public void actionAudit_actionPerformed(ActionEvent e) throws Exception {
		...
		for(int i = 0; i < id.size(); i++){
			...
			if (!FDCBillStateEnum.SUBMITTED.equals(TripApplyFactory.getRemoteInstance().getTripApplyInfo(new ObjectUuidPK(id.get(i).toString())).getState())) {
	...
	public void actionUnAudit_actionPerformed(ActionEvent e) throws Exception {
		...
		for(int i = 0; i < id.size(); i++){
			FDCClientUtils.checkBillInWorkflow(this, id.get(i).toString());
			TripApplyInfo info=TripApplyFactory.getRemoteInstance().getTripApplyInfo(new ObjectUuidPK(id.get(i).toString()));
...
//		mainQuery.setFilter(getTreeSelectFilter(project));
	...
	protected ICoreBase getBizInterface() throws Exception {
		return TripApplyFactory.getRemoteInstance();
	}
	protected String getEditUIName() {
		return TripApplyEditUI.class.getName();
	}
