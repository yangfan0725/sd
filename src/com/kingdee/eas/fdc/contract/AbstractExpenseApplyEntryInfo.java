...
public class AbstractExpenseApplyEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractExpenseApplyEntryInfo()
    {
        this("id");
    }
    protected AbstractExpenseApplyEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**
     ...
     */
    public com.kingdee.eas.fdc.contract.ExpenseApplyInfo getParent()
    {
        return (com.kingdee.eas.fdc.contract.ExpenseApplyInfo)get("parent");
    }
    public void setParent(com.kingdee.eas.fdc.contract.ExpenseApplyInfo item)
    {
        put("parent", item);
    }
    /**
