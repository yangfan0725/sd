...
public class TripCostEditDataProvider extends FDCBillDataProvider   {

	public TripCostEditDataProvider(String billId, IMetaDataPK mainQuery) {
		super(billId, mainQuery);
		// TODO Auto-generated constructor stub
	}
private static final Logger logger = Logger.getLogger(TripCostEditDataProvider.class);
