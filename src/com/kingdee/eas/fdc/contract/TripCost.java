...
public class TripCost extends FDCBill implements ITripCost
{
    public TripCost()
    {
        super();
        registerInterface(ITripCost.class, this);
    }
    public TripCost(Context ctx)
    {
        super(ctx);
        registerInterface(ITripCost.class, this);
    }
    ...
    private TripCostController getController() throws BOSException
    {
        return (TripCostController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getTripCostInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTripCostInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTripCostInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTripCostCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTripCostCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTripCostCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
