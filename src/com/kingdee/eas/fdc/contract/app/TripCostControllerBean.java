...
public class TripCostControllerBean extends AbstractTripCostControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.contract.app.TripCostControllerBean");
...
protected void _audit(Context ctx, BOSUuid billId) throws BOSException,
	...
	TripCostInfo tripInfo=this.getTripCostInfo(ctx, new ObjectUuidPK(billId),sic);
...
//	receivingBillInfo.setSourceType(SourceTypeEnum.CASH);
	...
	payment.setUsage(tripInfo.getPerson().getName()+FDCDateHelper.DateToString(tripInfo.getBizDate())+" 出差费用报销，出差地点"+tripInfo.getPlace()+"，金额"+tripInfo.getAmount()+"元；");
	...
	payBillEntryInfo.setRemark(tripInfo.getPerson().getName()+FDCDateHelper.DateToString(tripInfo.getBizDate())+" 出差费用报销，出差地点"+tripInfo.getPlace()+"，金额"+tripInfo.getAmount()+"元；");
...
private String getNumber(Context ctx,PaymentBillInfo  receivingBillInfo,TripCostInfo revGatherInfo) throws BOSException, EASBizException
{		
