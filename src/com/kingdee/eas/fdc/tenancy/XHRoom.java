...
public class XHRoom extends FDCDataBase implements IXHRoom
{
    public XHRoom()
    {
        super();
        registerInterface(IXHRoom.class, this);
    }
    public XHRoom(Context ctx)
    {
        super(ctx);
        registerInterface(IXHRoom.class, this);
    }
    ...
    private XHRoomController getController() throws BOSException
    {
        return (XHRoomController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getXHRoomInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getXHRoomInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getXHRoomInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getXHRoomCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getXHRoomCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getXHRoomCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
