...
public class ExpenseApply extends FDCBill implements IExpenseApply
{
    public ExpenseApply()
    {
        super();
        registerInterface(IExpenseApply.class, this);
    }
    public ExpenseApply(Context ctx)
    {
        super(ctx);
        registerInterface(IExpenseApply.class, this);
    }
    ...
    private ExpenseApplyController getController() throws BOSException
    {
        return (ExpenseApplyController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getExpenseApplyInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getExpenseApplyInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getExpenseApplyInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getExpenseApplyCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getExpenseApplyCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getExpenseApplyCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
