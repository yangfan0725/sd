 ...
 * output class name
 */
public abstract class AbstractExpenseApplyEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractExpenseApplyEditUI.class);
    ...
    protected com.kingdee.eas.fdc.contract.ExpenseApplyInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractExpenseApplyEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractExpenseApplyEditUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        contAttachment.setBounds(new Rectangle(22, 352, 974, 156));
        this.add(contAttachment, new KDLayout.Constraints(22, 352, 974, 156, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        contBizDate.setBounds(new Rectangle(374, 54, 270, 19));
        this.add(contBizDate, new KDLayout.Constraints(374, 54, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contAmount.setBounds(new Rectangle(726, 53, 270, 19));
        this.add(contAmount, new KDLayout.Constraints(726, 53, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contExpenseType.setBounds(new Rectangle(374, 31, 270, 19));
        this.add(contExpenseType, new KDLayout.Constraints(374, 31, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contDept.setBounds(new Rectangle(22, 77, 270, 19));
        this.add(contDept, new KDLayout.Constraints(22, 77, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contPerson.setBounds(new Rectangle(374, 76, 270, 19));
        this.add(contPerson, new KDLayout.Constraints(374, 76, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contPurpose.setBounds(new Rectangle(24, 288, 969, 60));
        this.add(contPurpose, new KDLayout.Constraints(24, 288, 969, 60, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        tblEntry.setBounds(new Rectangle(21, 102, 974, 179));
        this.add(tblEntry, new KDLayout.Constraints(21, 102, 974, 179, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        contContractWFType.setBounds(new Rectangle(726, 31, 270, 19));
        this.add(contContractWFType, new KDLayout.Constraints(726, 31, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contName.setBounds(new Rectangle(22, 54, 270, 19));
        this.add(contName, new KDLayout.Constraints(22, 54, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        //contCreator
...
contAttachment.getContentPane().setLayout(new BorderLayout(0, 0));        contAttachment.getContentPane().add(tblAttachement, BorderLayout.CENTER);
	...
	private void registerBindings(){
		dataBinder.registerBinding("entry", com.kingdee.eas.fdc.contract.ExpenseApplyEntryInfo.class, this.tblEntry, "userObject");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.contract.app.ExpenseApplyEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.contract.ExpenseApplyInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.contract.client", "ExpenseApplyEditUI");
    }
    /**
