 ...
 * output class name
 */
public class PurchaseDocumentEditUI extends AbstractPurchaseDocumentEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(PurchaseDocumentEditUI.class);
    public PurchaseDocumentEditUI() throws Exception
    {
        super();
    }
	...
	protected IObjectValue createNewData() {
		PurchaseDocumentInfo info=new PurchaseDocumentInfo();
	...
	protected String getTDFileName() {
		return "/bim/fdc/contract/PurchaseDocument";
	}

	protected IMetaDataPK getTDQueryPK() {
		return new MetaDataPK(
				"com.kingdee.eas.fdc.contract.app.PurchaseDocumentQuery");
	}
	public void actionPrint_actionPerformed(ActionEvent e) throws Exception {
		...
		PurchaseDocumentEditDataProvider dataPvd = new PurchaseDocumentEditDataProvider(
