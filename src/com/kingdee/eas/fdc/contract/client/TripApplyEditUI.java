 ...
 * output class name
 */
public class TripApplyEditUI extends AbstractTripApplyEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(TripApplyEditUI.class);
    
    /**
     * output class constructor
     */
    public TripApplyEditUI() throws Exception
    {
        super();
    }
    public void onLoad() throws Exception {
		...
		filter.getFilterItems().add(new FilterItemInfo("isTrip",Boolean.TRUE));
	...
	protected IObjectValue createNewData() {
		TripApplyInfo info=new TripApplyInfo();
	...
	protected String getTDFileName() {
		return "/bim/fdc/contract/TripApply";
	}

	protected IMetaDataPK getTDQueryPK() {
		return new MetaDataPK(
				"com.kingdee.eas.fdc.contract.app.TripApplyPrintQuery");
	}
	public void actionPrint_actionPerformed(ActionEvent e) throws Exception {
		...
		TripApplyEditDataProvider dataPvd = new TripApplyEditDataProvider(
